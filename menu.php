...
<body class="dekstop">
    ...
    <div class="container my-5">
        <div class="card-deck">
            <div class="card">
                <img class="card-img-top" src="./img/—Pngtree—healthy food_3776802.png" alt="Card image cap">
                <div class="card-body">
            ...
            <div class="card">
                <img class="card-img-top" src="./img/hotpot.png" alt="Card image cap">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
            ...
            <div class="card">
                <img class="card-img-top" src="./img/chickenRice.png" alt="Card image cap">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
    ...
    <div class="container my-5">
        <div class="card-deck">
            <div class="card">
                <img class="card-img-top" src="./img/Soyu Ramen.png" alt="Card image cap">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
            ...
            <div class="card">
                <img class="card-img-top" src="./img/TaichanSatay.png" alt="Card image cap">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
